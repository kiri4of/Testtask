...
3. [Troubleshooting and Common Issues](#3-troubleshooting-and-common-issues)
    - [3.1. Offline / “No Internet” Screen](#32-offline--no-internet-screen)
    - [3.2. Pagination Stops](#33-pagination-stops)
    - [3.3. Registration Button Disabled](#34-registration-button-disabled)
    - [3.4. Token Issues](#35-token-issues)
